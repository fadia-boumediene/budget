...
class InitPortObserver
{
     ...
     * @return void
     */
    public function created(InitPort $initPort): void
    {
                //\Log::info('initPort created: ' . get_class($initPort));
                $this->logActivity('created', $initPort);
    }
  ...
  /**
     ...
     * @return void
     */
    public function deleted(InitPort $initPort): void
    {
        $this->logActivity('deleted', $initPort);
    }
